...
QT_MOC_LITERAL(6, 58, 19), // "on_question_clicked"
QT_MOC_LITERAL(7, 78, 11), // "recieveData"
QT_MOC_LITERAL(8, 90, 3) // "str"

    },
    "GameScene\0firstWindow\0\0Generation\0"
    "on_back_clicked\0animate\0on_question_clicked\0"
    "recieveData\0str"
};
#undef QT_MOC_LITERAL
...
void GameScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->recieveData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
